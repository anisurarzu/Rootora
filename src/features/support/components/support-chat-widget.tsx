...
export function SupportChatWidget() {
  ...
  useEffect(() => {
    ...
    const sync = () => {
      ...
      // MUST set position:fixed — otherwise top/height are ignored.
  ...
  const chatPanel = open ? (
    <>
      <div
        className="fixed inset-0 z-[99998] bg-white md:hidden"
        aria-hidden
      />
      <div className="pointer-events-none fixed inset-0 z-[99999] md:inset-auto md:bottom-6 md:right-6">
        <div
          ref={frameRef}
          ...
          {needsEmail && showEmailForm ? (
            <div className="shrink-0 space-y-2 border-t border-border bg-amber-50 p-3">
              ...
              <Input
                ...
                className="h-9 bg-white text-base md:text-sm"
              />
              <Input
                type="email"
